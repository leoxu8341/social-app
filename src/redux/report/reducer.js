...
export default function reducer(state = initState, action) {
  switch (action.type) {
    ...
    case actions.REPORT_LOGIN_LIST_SUCCESS:
      return state.set('loading', false).set('logins', action.payload)
    ...
    case actions.REPORT_PROFILE_LIST_SUCCESS:
      return state.set('loading', false).set('recentProfiles', action.payload)
    ...
    case actions.REPORT_SENDER_LIST_SUCCESS:
      return state.set('loading', false).set('senders', action.payload)
    ...
    case actions.REPORT_USER_LIST_SUCCESS:
      return state.set('loading', false).set('profileViewUsers', action.payload)
    ...
    case actions.REPORT_USER_PROFILE_VIEW_SUCCESS:
      return state.set('oneLoading', false).set('profileView', action.payload)
