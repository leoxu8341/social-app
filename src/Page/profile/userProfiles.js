...
const { profileListRequest, hobbyListRequest } = profileAction
          ...
          <Row style={{ marginBottom: 20 }}>
            <Space>
              ...
              <InputNumber
                min={1}
                max={200}
                defaultValue={ageMin ? ageMin : null}
              ...
              <InputNumber
                min={1}
                max={200}
                defaultValue={ageMax ? ageMax : null}
          ...
          <Row style={{ marginBottom: 20 }}>
            <Space>
              ...
              <InputNumber
                min={1}
                max={8}
                defaultValue={feet ? feet : null}
                onChange={onFeetChange}
              />
              <InputNumber
                min={1}
                max={12}
                defaultValue={inch ? inch : null}
                ...
                <List.Item.Meta
                  ...
                  title={
                    <Button
                      size="small"
                      type="link"
                      onClick={() => navigate('/users/profile/' + item.key)}
                    >
                      {item.name}
                    </Button>
                  }
