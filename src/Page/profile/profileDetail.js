    ...
    return (
        <Row gutter={16}>
            <Col span={16}>
                ...
                <Button style={{ marginLeft: 50}} type="primary" onClick={() => handleOnClick() }>Write Letter</Button>
                <Modal
                    okText="Send"
                    title="Letter"
                    open={visible}
                ...
                >
                    ...
                    <Row>
                        <TextArea rows={8} placeholder="body goes here..." value={body} onChange={e => setBody(e.target.value)} />
                    </Row>
                </Modal>
            </Col>
        </Row>
